...
for mpcule_id, species_dict in mpcule_id_molecule_dict.items():
    species_name = nm.generate_species_name(species_dict, func_group_dict)
    
    if species_name in stereo_dict:
        nm.update_names(species_name, stereo_dict, name_mpcule_dict, mpcule_id)
